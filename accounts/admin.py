...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ["email", "username", "first_name", "last_name", "profile_picture", "date_of_birth"]
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ["email", "username", "first_name", "last_name", "password", "date_of_birth", "is_active", "is_admin"]
